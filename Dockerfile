FROM ubuntu:jammy
LABEL "creator"="BIND 9 Developers <bind9-dev@isc.org>"
LABEL "arm_version"="Pedro Azevedo <pedrolsazevedo@gmail.com>"
LABEL "OS/ARCH"="linux/arm64/v8"

ENV DEBIAN_FRONTEND noninteractive
ENV LC_ALL C.UTF-8

ARG DEB_VERSION=1:9.19.7-1+ubuntu22.04.1+isc+1
